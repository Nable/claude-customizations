...
The command will be available in Claude Code as `/marketing-advisor`.
...
1. Run `/app-store-listing` first — Marketing Advisor reads it to better understand the app
2. Run `/marketing-advisor`
